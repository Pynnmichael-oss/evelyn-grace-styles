...
// on the current page (About, Experience, Services, Shop, and Process
// are their own routes; Home is a section on the home page itself).
// useScrollToHash (in App.jsx) handles the actual scroll once the
// target section is on-page. Contact is the one plain anchor: every
// page renders its own Footer with id="contact", so it should always
// target the CURRENT page's footer, not force a trip back to Home's.
const NAV_LINKS = [
  { label: 'Home', to: '/#home' },
